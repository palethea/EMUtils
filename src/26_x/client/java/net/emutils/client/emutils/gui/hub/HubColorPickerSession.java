...
public final class HubColorPickerSession {
	...
	public void render(net.minecraft.client.gui.GuiGraphicsExtractor context, int mouseX, int mouseY) {
		...
		int left = popupX(context.guiWidth());
		int top = popupY(context.guiHeight());
	...
	private void drawPickerHandle(net.minecraft.client.gui.GuiGraphicsExtractor context, int centerX, int centerY) {
	...
	private static void drawHandle(net.minecraft.client.gui.GuiGraphicsExtractor context, int x, int y) {
	...
	public boolean handleMouseButtonEvent(double mouseX, double mouseY, int screenWidth, int screenHeight) {
		int left = popupX(screenWidth);
		int top = popupY(screenHeight);
		int centerX = left + POPUP_SIZE / 2;
		int centerY = top + POPUP_SIZE / 2;
