...
public final class ChatMessageDecorations {
	...
	public static Component stripAll(Component message) {
		return Component.literal(stripAllString(message.getString()));
	}
	...
	public static int extractDuplicateCount(Component message) {
	...
	public static OptionalLong parseTimestampMillis(Component message) {
	...
	public static ChatMessageMetadata metadataFromDisplayed(Component displayed, long fallbackReceivedAtMillis) {
		...
		Component baseMessage = stripAll(displayed);
