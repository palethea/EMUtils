...
public final class EMUtilsTexts {
    ...
    public static final String UI_SHORTCUT_TEXT_PLACEHOLDER = "emutils.ui.shortcut.text_placeholder";
    public static final String UI_SHORTCUT_TEXT_HINT = "emutils.ui.shortcut.text_hint";
    public static final String UI_SHORTCUT_RUNS_COMMAND = "emutils.ui.shortcut.runs_command";
    public static final String UI_SHORTCUT_SENDS_MESSAGE = "emutils.ui.shortcut.sends_message";
    public static final String UI_SHORTCUT_KEYS = "emutils.ui.shortcut.keys";
    public static final String UI_SHORTCUT_CLICK_TO_SET = "emutils.ui.shortcut.click_to_set";
    public static final String UI_SHORTCUT_KEYS_HINT = "emutils.ui.shortcut.keys_hint";
    public static final String UI_SHORTCUT_KEYS_TAKEN = "emutils.ui.shortcut.keys_taken";
    public static final String UI_SHORTCUT_COUNT = "emutils.ui.shortcut.count";
    public static final String UI_SHORTCUT_COUNT_ONE = "emutils.ui.shortcut.count_one";
    public static final String UI_SHORTCUT_DISABLED = "emutils.ui.shortcut.disabled";
    public static final String UI_SHORTCUT_EMPTY = "emutils.ui.shortcut.empty";
    public static final String UI_SHORTCUT_TYPE_COMMAND = "emutils.ui.shortcut.type_command";
    public static final String UI_SHORTCUT_TYPE_MESSAGE = "emutils.ui.shortcut.type_message";
    public static final String UI_SHORTCUT_CLEAR_MESSAGE = "emutils.ui.shortcut.clear_message";
    public static final String UI_SHORTCUT_CLEAR_MESSAGE_ONE = "emutils.ui.shortcut.clear_message_one";
    public static final String UI_SCRIPT_FIND_PLACEHOLDER = "emutils.ui.script.find.placeholder";
    public static final String UI_SCRIPT_FIND_COUNT = "emutils.ui.script.find.count";
    public static final String UI_SCRIPT_FIND_FOUND = "emutils.ui.script.find.found";
    public static final String UI_SCRIPT_FIND_NONE = "emutils.ui.script.find.none";
    public static final String UI_SCRIPT_FIND_PREVIOUS = "emutils.ui.script.find.previous";
    public static final String UI_SCRIPT_FIND_NEXT = "emutils.ui.script.find.next";
    public static final String UI_SCRIPT_FIND_CLOSE = "emutils.ui.script.find.close";
    public static final String UI_SCRIPT_ERROR_LINE = "emutils.ui.script.error.line";
    public static final String UI_SCRIPT_ERROR_GO_TO = "emutils.ui.script.error.go_to";
    public static final String UI_SCRIPT_RENAME = "emutils.ui.script.rename";
    public static final String UI_SCRIPT_RENAME_TOOLTIP = "emutils.ui.script.rename.tooltip";
    public static final String UI_SCRIPT_RENAME_TITLE = "emutils.ui.script.rename.title";
    public static final String UI_SCRIPT_RENAME_MESSAGE = "emutils.ui.script.rename.message";
    public static final String UI_SCRIPT_RENAME_FOLDER_MESSAGE = "emutils.ui.script.rename.folder_message";
    public static final String UI_SCRIPT_RENAME_CONFIRM = "emutils.ui.script.rename.confirm";
    public static final String UI_SCRIPT_RENAMED = "emutils.ui.script.renamed";
    public static final String UI_SCRIPT_NEW_FOLDER = "emutils.ui.script.new_folder";
    public static final String UI_SCRIPT_NEW_FOLDER_HERE = "emutils.ui.script.new_folder.here";
    public static final String UI_SCRIPT_NEW_SCRIPT_HERE = "emutils.ui.script.new_script.here";
    public static final String UI_SCRIPT_NEW_FOLDER_MESSAGE = "emutils.ui.script.new_folder.message";
    public static final String UI_SCRIPT_NEW_FOLDER_PLACEHOLDER = "emutils.ui.script.new_folder.placeholder";
    public static final String UI_SCRIPT_FOLDER_CREATED = "emutils.ui.script.folder_created";
    public static final String UI_SCRIPT_DELETE_FOLDER = "emutils.ui.script.delete_folder";
    public static final String UI_SCRIPT_DELETE_FOLDER_TITLE = "emutils.ui.script.delete_folder.title";
    public static final String UI_SCRIPT_DELETE_FOLDER_MESSAGE = "emutils.ui.script.delete_folder.message";
    public static final String UI_SCRIPT_DELETE_FOLDER_MESSAGE_ONE = "emutils.ui.script.delete_folder.message_one";
    public static final String UI_SCRIPT_DELETE_FOLDER_EMPTY = "emutils.ui.script.delete_folder.empty";
    public static final String UI_SCRIPT_FOLDER_DELETED = "emutils.ui.script.folder_deleted";
    public static final String UI_SCRIPT_RUN = "emutils.ui.script.run";
    ...
    public static final String UI_OPEN_SCREENSHOTS_FOLDER = "emutils.ui.gallery.open_folder";
    public static final String UI_SORT_NEWEST = "emutils.ui.gallery.sort_newest";
    public static final String UI_SORT_OLDEST = "emutils.ui.gallery.sort_oldest";
    public static final String UI_SCREENSHOT_COUNT = "emutils.ui.gallery.count";
    public static final String UI_SCREENSHOT_COUNT_ONE = "emutils.ui.gallery.count_one";
    public static final String UI_CANT_READ_SCREENSHOT = "emutils.ui.gallery.cant_read";
    public static final String UI_CLOSE = "emutils.ui.close";
    public static final String UI_PREVIOUS = "emutils.ui.previous";
    public static final String UI_NEXT = "emutils.ui.next";
    public static final String UI_POSITION_OF = "emutils.ui.position_of";
    public static final String UI_ADD = "emutils.ui.add";
    public static final String UI_DELETE = "emutils.ui.delete";
    public static final String UI_CLEAR_ALL = "emutils.ui.clear_all";
    public static final String UI_BLOCKS = "emutils.ui.blocks";
    public static final String UI_ADD_WAYPOINT = "emutils.ui.waypoint.add";
    public static final String UI_WAYPOINT_COUNT = "emutils.ui.waypoint.count";
    public static final String UI_WAYPOINT_COUNT_ONE = "emutils.ui.waypoint.count_one";
    public static final String UI_WAYPOINT_NAME = "emutils.ui.waypoint.name";
    public static final String UI_WAYPOINT_POSITION = "emutils.ui.waypoint.position";
    public static final String UI_WAYPOINT_COLOR = "emutils.ui.waypoint.color";
