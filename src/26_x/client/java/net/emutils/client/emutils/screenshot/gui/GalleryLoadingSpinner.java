...
public final class GalleryLoadingSpinner {
	...
	public static void render(GuiGraphicsExtractor context, int centerX, int centerY) {
		render(context, centerX, centerY, ORBIT_RADIUS);
	}

	public static void render(GuiGraphicsExtractor context, int centerX, int centerY, int orbitRadius) {
