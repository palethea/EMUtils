...
public final class WaypointWorldRenderBridge {
	...
	private WaypointWorldRenderBridge() {
	}

	public static void register() {
		WorldRenderEvents.AFTER_ENTITIES.register(WaypointWorldRenderBridge::render);
	}
