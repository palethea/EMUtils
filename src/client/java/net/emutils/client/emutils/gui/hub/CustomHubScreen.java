...
public final class CustomHubScreen extends Screen {
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		int versionX = panelX + CONTENT_PADDING;
		int versionY = panelY + panelHeight - BOTTOM_PADDING - FOOTER_BUTTON_HEIGHT + (FOOTER_BUTTON_HEIGHT - textRenderer.fontHeight) / 2;
		context.drawTextWithShadow(textRenderer, versionText, versionX, versionY, HubPanelTheme.TEXT_MUTED);
