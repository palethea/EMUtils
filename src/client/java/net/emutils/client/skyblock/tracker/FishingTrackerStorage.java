...
import net.emutils.client.skyblock.fishing.tracker.profit.FishingProfitTrackerData;
import net.emutils.client.skyblock.fishing.tracker.seacreature.SeaCreatureTrackerData;
