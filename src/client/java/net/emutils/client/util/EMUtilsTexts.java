...
public final class EMUtilsTexts {
	...
	public static final String SCREEN_PACK_MANAGER = "emutils.screen.pack_manager";
	...
	public static final String OPTION_CHAT_MENTION_HIGHLIGHT = "emutils.option.chat_mention_highlight";
	public static final String OPTION_CHAT_MENTION_HIGHLIGHT_COLOR = "emutils.option.chat_mention_highlight_color";
	...
	public static final String OPTION_HUD_LAYOUT_MODE = "emutils.option.hud_layout_mode";
	public static final String OPTION_HUD_LAYOUT_EDITOR = "emutils.option.hud_layout_editor";
	public static final String SCREEN_HUD_LAYOUT_EDITOR = "emutils.screen.hud_layout_editor";
	...
	public static final String HUD_ELEMENT_SPOTIFY = "emutils.hud.element.spotify";
	...
	public static final String OPTION_ZOOM_AMOUNT = "emutils.option.zoom_amount";
	public static final String OPTION_ZOOM_CINEMATIC_CAMERA = "emutils.option.zoom_cinematic_camera";
	public static final String OPTION_ZOOM_HIDE_HAND = "emutils.option.zoom_hide_hand";
	public static final String OPTION_ZOOM_SMOOTH_TRANSITION = "emutils.option.zoom_smooth_transition";
	public static final String OPTION_ZOOM_TRANSITION_SPEED = "emutils.option.zoom_transition_speed";
	public static final String OPTION_ZOOM_HIDE_HUD = "emutils.option.zoom_hide_hud";
	public static final String OPTION_TWEAK_FULLBRIGHT = "emutils.option.tweak_fullbright";
	public static final String OPTION_TWEAK_NO_FOG = "emutils.option.tweak_no_fog";
	public static final String OPTION_TWEAK_CLEAR_UNDERWATER = "emutils.option.tweak_clear_underwater";
	public static final String OPTION_TWEAK_CLEAR_LAVA = "emutils.option.tweak_clear_lava";
	public static final String OPTION_TWEAK_NO_ENVIRONMENT_FOG = "emutils.option.tweak_no_environment_fog";
	public static final String OPTION_TWEAK_NO_HURT_CAM = "emutils.option.tweak_no_hurt_cam";
	public static final String OPTION_TWEAK_FREELOOK = "emutils.option.tweak_freelook";
	public static final String OPTION_TWEAK_SHULKER_TOOLTIP_PREVIEW = "emutils.option.tweak_shulker_tooltip_preview";
	public static final String OPTION_TWEAK_BUNDLE_TOOLTIP_PREVIEW = "emutils.option.tweak_bundle_tooltip_preview";
	public static final String OPTION_TWEAK_CLEAR_WEATHER = "emutils.option.tweak_clear_weather";
	public static final String OPTION_TWEAK_OWN_NAMETAG = "emutils.option.tweak_own_nametag";
	public static final String OPTION_PACK_MANAGER = "emutils.option.pack_manager";
	public static final String OPTION_PACK_MANAGER_SHOW_SHADERS_WITHOUT_IRIS = "emutils.option.pack_manager_show_shaders_without_iris";
	public static final String OPTION_PACK_MANAGER_SEARCH_LIMIT = "emutils.option.pack_manager_search_limit";
	public static final String OPTION_CUSTOM_CAPES = "emutils.option.custom_capes";
	public static final String OPTION_CAPE_OPTIFINE = "emutils.option.cape.optifine";
	public static final String OPTION_CAPE_LABYMOD = "emutils.option.cape.labymod";
	public static final String OPTION_CAPE_MINECRAFTCAPES = "emutils.option.cape.minecraftcapes";
	public static final String OPTION_CAPE_COSMETICA = "emutils.option.cape.cosmetica";
	public static final String OPTION_CAPE_CLOAKSPLUS = "emutils.option.cape.cloaksplus";
	public static final String OPTION_CAPE_PREFERRED_PROVIDER = "emutils.option.cape.preferred_provider";
	public static final String OPTION_CAPE_PREFERRED_AUTO = "emutils.option.cape.preferred.auto";
	public static final String CAPES_HINT = "emutils.capes.hint";
	public static final String OPTION_SPOTIFY_PLAYER = "emutils.option.spotify_player";
	public static final String OPTION_SPOTIFY_HUD_OVERLAY = "emutils.option.spotify_hud_overlay";
	public static final String OPTION_SPOTIFY_HUD_BACKGROUND_OPACITY = "emutils.option.spotify_hud_background_opacity";
	public static final String OPTION_SPOTIFY_HUD_SCALE = "emutils.option.spotify_hud_scale";
	public static final String OPTION_INVENTORY_TOOLS = "emutils.option.inventory_tools";
	public static final String OPTION_SKYBLOCK = "emutils.option.skyblock";
	public static final String OPTION_STORAGE_PREVIEW = "emutils.option.storage_preview";
	public static final String OPTION_BAZAAR_TOOLTIPS = "emutils.option.bazaar_tooltips";
	public static final String OPTION_AUCTION_TOOLTIPS = "emutils.option.auction_tooltips";
	public static final String OPTION_NPC_SELL_PRICE_TOOLTIPS = "emutils.option.npc_sell_price_tooltips";
	public static final String OPTION_SKYBLOCK_STATS_HUD = "emutils.option.skyblock_stats_hud";
	public static final String OPTION_SKYBLOCK_STATS_HIDE_ACTION_BAR = "emutils.option.skyblock_stats_hide_action_bar";
	public static final String OPTION_SKYBLOCK_STATS_HEALTH = "emutils.option.skyblock_stats_health";
	public static final String OPTION_SKYBLOCK_STATS_DEFENSE = "emutils.option.skyblock_stats_defense";
	public static final String OPTION_SKYBLOCK_STATS_MANA = "emutils.option.skyblock_stats_mana";
	public static final String OPTION_SKYBLOCK_STATS_SOULFLOW = "emutils.option.skyblock_stats_soulflow";
	public static final String OPTION_SKYBLOCK_STATS_POSITION = "emutils.option.skyblock_stats_position";
	public static final String OPTION_SKYBLOCK_STATS_BACKGROUND_OPACITY = "emutils.option.skyblock_stats_background_opacity";
	public static final String OPTION_SKYBLOCK_STATS_SCALE = "emutils.option.skyblock_stats_scale";
	public static final String OPTION_ESTIMATED_ITEM_VALUE_HUD = "emutils.option.estimated_item_value_hud";
	public static final String OPTION_ESTIMATED_ITEM_VALUE_POSITION = "emutils.option.estimated_item_value_position";
	public static final String OPTION_ESTIMATED_ITEM_VALUE_SCALE = "emutils.option.estimated_item_value_scale";
	...
	public static final String OPTION_SLOT_LOCKING = "emutils.option.slot_locking";
	public static final String OPTION_SLOT_BINDING = "emutils.option.slot_binding";
	public static final String OPTION_SLOT_LOCK_COLOR = "emutils.option.slot_lock_color";
	public static final String OPTION_BOUND_SLOT_COLOR = "emutils.option.bound_slot_color";
	public static final String OPTION_SLOT_BINDING_SHOW_ICONS = "emutils.option.slot_binding_show_icons";
	public static final String OPTION_SLOT_BINDING_LOCK_BOUND_SLOTS = "emutils.option.slot_binding_lock_bound_slots";
	public static final String OPTION_INVENTORY_PREVIEW = "emutils.option.inventory_preview";
	public static final String OPTION_PRESERVE_CONTAINER_CURSOR = "emutils.option.preserve_container_cursor";
	public static final String OPTION_INVENTORY_PREVIEW_OPACITY = "emutils.option.inventory_preview_opacity";
	public static final String INVENTORY_LOCK_COLOR_RED = "emutils.inventory.lock_color.red";
	public static final String INVENTORY_LOCK_COLOR_YELLOW = "emutils.inventory.lock_color.yellow";
	public static final String INVENTORY_LOCK_COLOR_GREEN = "emutils.inventory.lock_color.green";
	public static final String INVENTORY_LOCK_COLOR_BLUE = "emutils.inventory.lock_color.blue";
	public static final String INVENTORY_BOUND_COLOR_GRAY = "emutils.inventory.bound_color.gray";
	public static final String INVENTORY_BOUND_COLOR_WHITE = "emutils.inventory.bound_color.white";
	public static final String INVENTORY_BOUND_COLOR_DARK_BLUE = "emutils.inventory.bound_color.dark_blue";
	public static final String SPOTIFY_PLAYER_TITLE = "emutils.spotify.player.title";
	public static final String SPOTIFY_PLAYER_NO_TRACK = "emutils.spotify.player.no_track";
	public static final String SPOTIFY_PLAYER_UNAVAILABLE = "emutils.spotify.player.unavailable";
	public static final String SPOTIFY_PLAYER_HINT = "emutils.spotify.player.hint";
	public static final String SPOTIFY_PREVIOUS = "emutils.spotify.action.previous";
	public static final String SPOTIFY_PLAY_PAUSE = "emutils.spotify.action.play_pause";
	...
	public static final String HUD_ANCHOR_BOTTOM_CENTER = "emutils.hud.anchor.bottom_center";
	...
	public static final String PACK_SECTION_INSTALLED = "emutils.pack.section.installed";
	public static final String PACK_SECTION_SEARCH = "emutils.pack.section.search";
	public static final String PACK_SECTION_INSTALLED_EMPTY_PACKS = "emutils.pack.section.installed_empty_packs";
	public static final String PACK_SECTION_INSTALLED_EMPTY_SHADERS = "emutils.pack.section.installed_empty_shaders";
	public static final String PACK_SECTION_SEARCH_HINT = "emutils.pack.section.search_hint";
	public static final String PACK_STATUS_NOT_INSTALLED = "emutils.pack.status.not_installed";
	public static final String PACK_TAB_RESOURCE_PACKS = "emutils.pack.tab.resource_packs";
	public static final String PACK_TAB_SHADER_PACKS = "emutils.pack.tab.shader_packs";
	public static final String PACK_TAB_INSTALLED = "emutils.pack.tab.installed";
	public static final String PACK_TAB_MODRINTH = "emutils.pack.tab.modrinth";
	public static final String PACK_SEARCH_PLACEHOLDER = "emutils.pack.search.placeholder";
	...
	public static final String PACK_SHADER_APPLIED = "emutils.pack.shader.applied";
	public static final String PACK_SHADER_APPLY_FAILED = "emutils.pack.shader.apply_failed";
	public static final String PACK_SHADER_DISABLED = "emutils.pack.shader.disabled";
	public static final String PACK_SHADER_DISABLE_FAILED = "emutils.pack.shader.disable_failed";
	public static final String PACK_OPEN_IRIS = "emutils.pack.action.open_iris";
	public static final String PACK_STATUS_INSTALLED = "emutils.pack.status.installed";
	public static final String PACK_STATUS_ENABLED = "emutils.pack.status.enabled";
	public static final String PACK_STATUS_SELECTED = "emutils.pack.status.selected";
	public static final String PACK_STATUS_IDLE = "emutils.pack.status.idle";
	public static final String PACK_STATUS_LOADING = "emutils.pack.status.loading";
	public static final String PACK_STATUS_EMPTY_PACKS = "emutils.pack.status.empty_packs";
	public static final String PACK_STATUS_EMPTY_SHADERS = "emutils.pack.status.empty_shaders";
	public static final String PACK_STATUS_IRIS_REQUIRED = "emutils.pack.status.iris_required";
	...
	public static final String PACK_DELETE_MESSAGE = "emutils.pack.delete.message";
	public static final String SCRIPT_MANAGER_REQUIRES_MINESCRIPT = "emutils.script_manager.requires_minescript";
	public static final String SCRIPT_MANAGER_EMPTY = "emutils.script_manager.empty";
	public static final String SCRIPT_MANAGER_READY = "emutils.script_manager.ready";
	public static final String SCRIPT_MANAGER_OPEN_FOLDER = "emutils.script_manager.open_folder";
	public static final String SCRIPT_MANAGER_NEW_SCRIPT = "emutils.script_manager.new_script";
	public static final String SCRIPT_MANAGER_REFRESH = "emutils.script_manager.refresh";
	public static final String SCRIPT_MANAGER_RUN = "emutils.script_manager.run";
	public static final String SCRIPT_MANAGER_SAVE = "emutils.script_manager.save";
	public static final String SCRIPT_MANAGER_SET_KEYBIND = "emutils.script_manager.set_keybind";
	public static final String SCRIPT_MANAGER_CLEAR_KEYBIND = "emutils.script_manager.clear_keybind";
	public static final String SCRIPT_MANAGER_DELETE = "emutils.script_manager.delete";
	public static final String SCRIPT_MANAGER_DELETE_TITLE = "emutils.script_manager.delete_title";
	public static final String SCRIPT_MANAGER_DELETE_MESSAGE = "emutils.script_manager.delete_message";
	public static final String SCRIPT_MANAGER_DELETED = "emutils.script_manager.deleted";
	public static final String SCRIPT_MANAGER_CREATE = "emutils.script_manager.create";
	public static final String SCRIPT_MANAGER_CREATE_HINT = "emutils.script_manager.create_hint";
	public static final String SCRIPT_MANAGER_LOADED = "emutils.script_manager.loaded";
	public static final String SCRIPT_MANAGER_READ_ONLY = "emutils.script_manager.read_only";
	public static final String SCRIPT_MANAGER_SAVED = "emutils.script_manager.saved";
	public static final String SCRIPT_MANAGER_RUNNING = "emutils.script_manager.running";
	public static final String SCRIPT_MANAGER_STOPPED = "emutils.script_manager.stopped";
	public static final String SCRIPT_MANAGER_UNSAFE_COMMAND = "emutils.script_manager.unsafe_command";
	public static final String SCRIPT_MANAGER_CAPTURE_KEY = "emutils.script_manager.capture_key";
	public static final String SCRIPT_MANAGER_KEYBIND_SET = "emutils.script_manager.keybind_set";
	public static final String SCRIPT_MANAGER_KEYBIND_CLEARED = "emutils.script_manager.keybind_cleared";
	public static final String SCRIPT_MANAGER_KEYBIND_TITLE = "emutils.script_manager.keybind_title";
	public static final String SCRIPT_MANAGER_KEYBIND_HINT = "emutils.script_manager.keybind_hint";
	public static final String SCRIPT_MANAGER_KEYBIND_UNSET = "emutils.script_manager.keybind_unset";
	public static final String SCRIPT_MANAGER_KEYBIND_PREVIEW = "emutils.script_manager.keybind_preview";
	public static final String SCRIPT_MANAGER_DUPLICATE_TITLE = "emutils.script_manager.duplicate_title";
	public static final String SCRIPT_MANAGER_DUPLICATE_MESSAGE = "emutils.script_manager.duplicate_message";
	public static final String SCRIPT_MANAGER_REPLACE_KEYBIND = "emutils.script_manager.replace_keybind";
	public static final String SCRIPT_MANAGER_UNSAVED_TITLE = "emutils.script_manager.unsaved_title";
	public static final String SCRIPT_MANAGER_UNSAVED_MESSAGE = "emutils.script_manager.unsaved_message";
	public static final String SCRIPT_MANAGER_DISCARD = "emutils.script_manager.discard";
