...
public enum HubCategory {
	...
	DEATH_WAYPOINTS(EMUtilsTexts.HUB_DEATH_WAYPOINTS),
	...
	SKYBLOCK(EMUtilsTexts.HUB_SKYBLOCK),
	SPOTIFY(EMUtilsTexts.HUB_SPOTIFY_PLAYER),
	PACKS(EMUtilsTexts.HUB_PACK_MANAGER),
	SCRIPTS(EMUtilsTexts.HUB_SCRIPT_MANAGER);
