...
public abstract class UnderwaterOverlayMixin {
	@Shadow
	private static void submitWater(Minecraft client, PoseStack poseStack, SubmitNodeCollector submitNodeCollector) {
	}
	...
	private static void emutils$skipUnderwaterOverlay(
		...
		submitWater(client, poseStack, submitNodeCollector);
	}
}
