...
- Beacon Radius Outline: draw a horizontal perimeter of each loaded active beacon's true effect boundary at your current viewing height, colored from its beam and toggleable with a configurable keybind.
